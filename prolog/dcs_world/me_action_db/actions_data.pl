...
actions_data(payload(task{id:"NoTask",params:[]}),no_task).
...
actions_data(payload(task{id:"AttackGroup",params:params{attackQty:1,attackQtyLimit:false,groupAttack:false}}),attack_group).
...
actions_data(payload(task{id:"AttackUnit",params:params{attackQty:1,attackQtyLimit:false,groupAttack:false}}),attack_unit).
...
actions_data(payload(task{id:"AttackMapObject",params:params{attackQty:1,attackQtyLimit:true,groupAttack:false}}),attack_map_object).
...
actions_data(payload(task{id:"Bombing",params:params{attackQty:1,attackQtyLimit:false,groupAttack:false}}),bombing).
...
actions_data(payload(task{id:"BombingRunway",params:params{attackQty:1,attackQtyLimit:false,groupAttack:true}}),bombing_runway).
...
actions_data(payload(task{id:"Orbit",params:[]}),orbit).
...
actions_data(payload(task{id:"Land",params:params{duration:300,durationFlag:false}}),land).
...
actions_data(payload(task{id:"Refueling",params:[]}),refueling).
...
actions_data(payload(task{id:"FAC_AttackGroup",params:[]}),fac_assign_group).
...
actions_data(payload(task{id:"FireAtPoint",params:params{expendQty:1,expendQtyEnabled:false,templateId:"",zoneRadius:0}}),fire_at_point).
...
actions_data(payload(task{id:"Hold",params:params{templateId:""}}),hold).
...
actions_data(payload(task{id:"Follow",params:params{lastWptIndexFlag:true,lastWptIndexFlagChangedManually:true,pos:pos{x: -500,y:0,z:200}}}),follow).
...
actions_data(payload(task{id:"Escort",params:params{engagementDistMax:60000,lastWptIndexFlag:true,lastWptIndexFlagChangedManually:true,pos:pos{x: -500,y:0,z:200},targetTypes:["Planes"]}}),escort).
...
actions_data(payload(task{id:"EmbarkToTransport",params:params{zoneRadius:200}}),embark_to_transport).
...
actions_data(payload(task{id:"GoToWaypoint",params:[]}),go_to_waypoint).
...
actions_data(payload(task{id:"Embarking",params:params{distribution:[],distributionFlag:false,duration:300,durationFlag:false,groupsForEmbarking:[]}}),embarking).
...
actions_data(payload(task{id:"Disembarking",params:params{groupsForEmbarking:[]}}),disembarking).
...
actions_data(payload(task{id:"CargoTransportation",params:[]}),cargo_transportation).
...
actions_data(payload(task{id:"GroundEscort",params:params{engagementDistMax:500,lastWptIndexFlag:true,lastWptIndexFlagChangedManually:true,targetTypes:["Helicopters","Ground Units"]}}),ground_escort).
...
actions_data(payload(task{id:"NoTask",params:[]}),no_enroute_task).
...
actions_data(payload(task{id:"EngageTargets",params:params{maxDist:15000,maxDistEnabled:false}}),search_then_engage).
...
actions_data(payload(task{id:"EngageTargetsInZone",params:params{zoneRadius:5000}}),search_then_engage_in_zone).
...
actions_data(payload(task{id:"EngageGroup",params:params{priority:1}}),search_then_engage_group).
...
actions_data(payload(task{id:"EngageUnit",params:params{attackQty:1,attackQtyLimit:false,groupAttack:false,priority:1}}),search_then_engage_unit).
...
actions_data(payload(task{id:"AWACS",params:[]}),awacs).
...
actions_data(payload(task{id:"EWR",params:[]}),ewr).
...
actions_data(payload(task{id:"FAC",params:[]}),fac).
...
actions_data(payload(task{id:"FAC_EngageGroup",params:[]}),fac_engage_group).
...
actions_data(payload(task{id:"Tanker",params:[]}),tanker).
...
actions_data(payload(task{id:"EngageTargets",key:"FighterSweep",params:params{priority:0,targetTypes:["Planes"]}}),fighter_sweep).
...
actions_data(payload(task{id:"EngageTargets",key:"CAS",params:params{priority:0,targetTypes:["Helicopters","Ground Units","Light armed ships"]}}),cas).
...
actions_data(payload(task{id:"EngageTargets",key:"CAP",params:params{priority:0,targetTypes:["Air"]}}),cap).
...
actions_data(payload(task{id:"EngageTargets",key:"SEAD",params:params{priority:0,targetTypes:["Air Defence"]}}),sead).
...
actions_data(payload(task{id:"EngageTargets",key:"AntiShip",params:params{priority:0,targetTypes:["Ships"]}}),anti_ship).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"NoAction",params:[]}}}),no_action).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Script",params:params{command:""}}}}),run_script).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"ScriptFile",params:params{file:""}}}}),script_file).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"SetCallsign",params:[]}}}),set_callsign).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"SetFrequency",params:params{frequency:131000000,modulation:0,power:10}}}}),set_frequency).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"SetFrequencyForUnit",params:params{frequency:131000000,modulation:0,power:10}}}}),set_frequency_for_unit).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"TransmitMessage",params:params{duration:5,file:"",loop:false,subtitle:""}}}}),transmit_message).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"StopTransmission",params:[]}}}),stop_transmission).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"SwitchWaypoint",params:[]}}}),switch_waypoint).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"SwitchAction",params:params{actionIndex:1}}}}),switch_action).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"SetInvisible",params:params{value:true}}}}),invisible).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"SetImmortal",params:params{value:true}}}}),immortal).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Start",params:[]}}}),start).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"ActivateBeacon",params:params{bearing:true,callsign:"TKR",channel:1,frequency:1088000000,modeChannel:"X",system:4,type:4}}}}),activate_tacan).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"DeactivateBeacon",params:[]}}}),deactivate_beacon).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"EPLRS",params:params{groupId:0,value:true}}}}),eplrs).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"SMOKE_ON_OFF",params:params{value:true}}}}),smoke_on_off).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name: -1}}}}),no_option).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:0}}}}),roe).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:1}}}}),reaction_to_threat).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:3}}}}),radar_using).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:4}}}}),chaff_flare_using).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:5}}}}),formation).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:6,value:true}}}}),rtb_on_bingo_fuel).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:10}}}}),rtb_on_out_of_ammo).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:7,value:false}}}}),silence).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:8,value:600}}}}),disperse_under_fire).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:9}}}}),alarm_state).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:13}}}}),ecm_using).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:14,value:false}}}}),restrict_air_to_air_attack).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:15,value:false}}}}),restrict_jettison).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:16,value:false}}}}),restrict_afterburner).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:17,value:false}}}}),restrict_air_to_ground_attack).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:18}}}}),aa_missile_attack_ranges).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:19,value:false}}}}),no_report_waypoint_pass).
...
actions_data(payload(task{id:"Aerobatics",params:params{maneuversParams:[]}}),aerobatics).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:20,value:true}}}}),engage_air_weapons).
...
actions_data(payload(task{id:"CarpetBombing",params:params{attackQty:1,attackQtyLimit:false,attackType:"Carpet",carpetLength:500,groupAttack:false,weaponType:weaponType{name:"--Iron bombs",value:240}}}),ww2_carpet_bombing).
...
actions_data(payload(task{id:"FollowBigFormation",params:params{formationType:0,lastWptIndexFlag:true,lastWptIndexFlagChangedManually:true,pos:pos{x: -150,y:0,z:150},posInBox:1,posInGroup:1,posInWing:1}}),ww2_big_formation).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:21}}}}),radio_usage_when_contact).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:22}}}}),radio_usage_when_engage).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"Option",params:params{name:23}}}}),radio_usage_when_kill_target).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"ActivateICLS",params:params{channel:1,type:131584}}}}),activate_icls).
...
actions_data(payload(task{id:"WrappedAction",params:params{action:action{id:"DeactivateICLS",params:[]}}}),deactivate_icls).
...
actions_data(payload(task{id:"ParatroopersDrop",params:params{attackQty:1,attackQtyLimit:false,attackType:"Carpet",carpetLength:500,groupAttack:false,groupsForAirdrop:[],scriptFileName:"",selectedGroup: -1}}),drop_of_paratroopers).
...
actions_data(payload(task{id:"AirboneDropOperation",params:params{dropType:"Troops",groupDrop:false,runsQty:1}}),airbone_drop_operation).
