...
skin(combined_arms_by_eagle_dynamics,skins(dir("./Mods/tech/CombinedArms/Skins/1"))).
skin(combined_arms_by_eagle_dynamics,skins(index(1))).
skin(combined_arms_by_eagle_dynamics,skins(name("CA"))).
...
skin(a_10c_warthog_by_eagle_dynamics,skins(dir("./Mods/aircraft/A-10C/Skins/1"))).
skin(a_10c_warthog_by_eagle_dynamics,skins(index(1))).
skin(a_10c_warthog_by_eagle_dynamics,skins(name("A-10C"))).
skin(av_8b_n_a_by_razbam_sims,dir_root("./Mods/aircraft/AV8BNA")).
skin(av_8b_n_a_by_razbam_sims,id("AV-8B N/A by RAZBAM Sims")).
skin(av_8b_n_a_by_razbam_sims,skins(dir("./Mods/aircraft/AV8BNA/Skins/1"))).
skin(av_8b_n_a_by_razbam_sims,skins(index(1))).
skin(av_8b_n_a_by_razbam_sims,skins(name("AV8BNA"))).
...
skin(bf_109_k_4_by_eagle_dynamics,skins(dir("./Mods/aircraft/Bf-109K-4/Skins/1"))).
skin(bf_109_k_4_by_eagle_dynamics,skins(index(1))).
skin(bf_109_k_4_by_eagle_dynamics,skins(name("Bf 109 K-4"))).
skin(f_86f_sabre_by_belsimtek,dir_root("./Mods/aircraft/F-86")).
skin(f_86f_sabre_by_belsimtek,id("F-86F Sabre by Belsimtek")).
skin(f_86f_sabre_by_belsimtek,skins(dir("./Mods/aircraft/F-86/Skins/1"))).
skin(f_86f_sabre_by_belsimtek,skins(index(1))).
skin(f_86f_sabre_by_belsimtek,skins(name("F-86F"))).
...
skin(f_14b_by_heatblur_simulations,skins(dir("./Mods/aircraft/F14/Skins"))).
skin(f_14b_by_heatblur_simulations,skins(index(1))).
skin(f_14b_by_heatblur_simulations,skins(name("F-14B"))).
skin(f_a_18c,dir_root("./Mods/aircraft/FA-18C")).
skin(f_a_18c,id("F/A-18C")).
skin(f_a_18c,skins(dir("./Mods/aircraft/FA-18C/Skins/1"))).
skin(f_a_18c,skins(index(1))).
skin(f_a_18c,skins(name("F/A-18C"))).
...
skin(fw_190_a_8_by_eagle_dynamics,skins(dir("./Mods/aircraft/FW-190A8/Skins/1"))).
skin(fw_190_a_8_by_eagle_dynamics,skins(index(1))).
skin(fw_190_a_8_by_eagle_dynamics,skins(name("Fw 190 A-8"))).
...
skin(fw_190d9_dora_by_eagle_dynamics,skins(dir("./Mods/aircraft/FW-190D9/Skins/1"))).
skin(fw_190d9_dora_by_eagle_dynamics,skins(index(1))).
skin(fw_190d9_dora_by_eagle_dynamics,skins(name("Fw 190 D-9"))).
...
skin(ka_50_black_shark_by_eagle_dynamics,skins(dir("./Mods/aircraft/Ka-50/Skins/1"))).
skin(ka_50_black_shark_by_eagle_dynamics,skins(index(1))).
skin(ka_50_black_shark_by_eagle_dynamics,skins(name("Ka-50"))).
skin(m_2000c_by_razbam_sims,dir_root("./Mods/aircraft/M-2000C")).
skin(m_2000c_by_razbam_sims,id("M-2000C by RAZBAM Sims")).
skin(m_2000c_by_razbam_sims,skins(dir("./Mods/aircraft/M-2000C/Skins/1"))).
skin(m_2000c_by_razbam_sims,skins(index(1))).
skin(m_2000c_by_razbam_sims,skins(name("M-2000C"))).
...
skin(mi_8mtv2_hip_by_belsimtek,skins(dir("./Mods/aircraft/Mi-8MTV2/Skins/1"))).
skin(mi_8mtv2_hip_by_belsimtek,skins(index(1))).
skin(mi_8mtv2_hip_by_belsimtek,skins(name("Mi-8MTV2"))).
...
skin(p_51d_mustang_by_eagle_dynamics,skins(dir("./Mods/aircraft/P-51D/Skins/1"))).
skin(p_51d_mustang_by_eagle_dynamics,skins(index(1))).
skin(p_51d_mustang_by_eagle_dynamics,skins(name("P-51D"))).
...
skin(sa342_gazelle_by_polychop_simulations,skins(dir("./Mods/aircraft/SA342/Skins/1"))).
skin(sa342_gazelle_by_polychop_simulations,skins(index(1))).
skin(sa342_gazelle_by_polychop_simulations,skins(name("SA342"))).
...
skin(spitfire_lf_mk_ix_by_eagle_dynamics,skins(dir("./Mods/aircraft/SpitfireLFMkIX/Skins/1"))).
skin(spitfire_lf_mk_ix_by_eagle_dynamics,skins(index(1))).
skin(spitfire_lf_mk_ix_by_eagle_dynamics,skins(name("Spitfire IX"))).
skin(su_25t_by_eagle_dynamics,dir_root("./Mods/aircraft/Su-25T")).
skin(su_25t_by_eagle_dynamics,id("Su-25T by Eagle Dynamics")).
skin(su_25t_by_eagle_dynamics,skins(dir("./Mods/aircraft/Su-25T/Theme"))).
skin(su_25t_by_eagle_dynamics,skins(index(1))).
skin(su_25t_by_eagle_dynamics,skins(name("Su-25T"))).
...
skin(su_33_flanker_by_eagle_dynamics,skins(dir("./Mods/aircraft/Su-33/Skins/1"))).
skin(su_33_flanker_by_eagle_dynamics,skins(index(1))).
skin(su_33_flanker_by_eagle_dynamics,skins(name("Su-33"))).
...
skin(tf_51d_mustang_by_eagle_dynamics,skins(dir("./Mods/aircraft/TF-51D/Skins/1"))).
skin(tf_51d_mustang_by_eagle_dynamics,skins(index(1))).
skin(tf_51d_mustang_by_eagle_dynamics,skins(name("TF-51D"))).
...
skin(uh_1h_huey_by_belsimtek,skins(dir("./Mods/aircraft/Uh-1H/Skins/1"))).
skin(uh_1h_huey_by_belsimtek,skins(index(1))).
skin(uh_1h_huey_by_belsimtek,skins(name("UH-1H"))).
skin(caucasus,dir_root("./Mods/terrains/Caucasus")).
skin(caucasus,id("Caucasus")).
skin(caucasus,skins(dir("./Mods/terrains/Caucasus/Theme"))).
skin(caucasus,skins(index(1))).
skin(caucasus,skins(name("Caucasus"))).
skin(nevada,dir_root("./Mods/terrains/Nevada")).
skin(nevada,id("Nevada")).
skin(nevada,skins(dir("./Mods/terrains/Nevada/Theme"))).
skin(nevada,skins(index(1))).
skin(nevada,skins(name("Nevada"))).
skin(normandy,dir_root("./Mods/terrains/Normandy")).
skin(normandy,id("Normandy")).
skin(normandy,skins(dir("./Mods/terrains/Normandy/Theme"))).
skin(normandy,skins(index(1))).
skin(normandy,skins(name("Normandy"))).
skin(persian_gulf,dir_root("./Mods/terrains/PersianGulf")).
skin(persian_gulf,id("PersianGulf")).
skin(persian_gulf,skins(dir("./Mods/terrains/PersianGulf/Theme"))).
skin(persian_gulf,skins(index(1))).
skin(persian_gulf,skins(name("Persian Gulf"))).
